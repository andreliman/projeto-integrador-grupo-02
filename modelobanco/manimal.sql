...
CREATE TABLE IF NOT EXISTS `manimals`.`breeds` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_breeds_kind1_idx` (`kind_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`profile` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_profile_users1_idx` (`id_user` ASC) VISIBLE,
  INDEX `fk_profile_breeds1_idx` (`id_breed` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`album` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_album_profile1_idx` (`id_profile` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`post` (
  ...
  `photo` CHAR(256) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_post_profile1_idx` (`id_profile` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`photos_content` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_photos_content_album1_idx` (`id_album` ASC) VISIBLE,
  INDEX `fk_photos_content_post1_idx` (`id_post` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`new_event` (
  ...
  `local` CHAR(256) NOT NULL,
  `descricao` TEXT NULL,
  `data_criacao` DATE NOT NULL,
  `foto_capa` CHAR(256) NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `foto_capa_UNIQUE` (`foto_capa` ASC) VISIBLE,
  INDEX `fk_new_event_profile1_idx` (`id_profile` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`event` (
  ...
  `localizacao` CHAR(256) NOT NULL,
  `qtd_comentarios` INT NOT NULL,
  `likes` INT NOT NULL,
  `share` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_event_new_event1_idx` (`id_new_event` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`friends` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_friends_profile1_idx` (`id_profile` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`share` (
  ...
  `id_profile` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_share_profile1_idx` (`id_profile` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`perfil_has_evento` (
  ...
  INDEX `fk_perfil_has_evento_evento1_idx` (`evento_id` ASC) VISIBLE,
  INDEX `fk_perfil_has_evento_perfil1_idx` (`perfil_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`likes` (
  ...
  `id_profile` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_likes_profile1_idx` (`id_profile` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`likes_has_event` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_likes_has_event_event1_idx` (`id_event` ASC) VISIBLE,
  INDEX `fk_likes_has_event_likes1_idx` (`id_like` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`comments_has_event` (
  ...
  `id_event` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_comments_has_event_event1_idx` (`id_event` ASC) VISIBLE,
  INDEX `fk_comments_has_event_comments1_idx` (`id_comment` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`profile_has_event` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_profile_has_event_event1_idx` (`event_id` ASC) VISIBLE,
  INDEX `fk_profile_has_event_profile1_idx` (`profile_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`event_has_share` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_event_has_share_share1_idx` (`id_share` ASC) VISIBLE,
  INDEX `fk_event_has_share_event1_idx` (`id_event` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`post_has_likes` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_post_has_likes_likes1_idx` (`id_likes` ASC) VISIBLE,
  INDEX `fk_post_has_likes_post1_idx` (`id_post` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`profile_has_comments` (
  ...
  `id_comment` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_profile_has_comments1_comments1_idx` (`id_comment` ASC) VISIBLE,
  INDEX `fk_profile_has_comments1_profile1_idx` (`id_profile` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`post_has_share` (
  ...
  `id_share` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_post_has_share_share1_idx` (`id_share` ASC) VISIBLE,
  INDEX `fk_post_has_share_post1_idx` (`id_post` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `manimals`.`post_has_comments` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_post_has_comments_comments1_idx` (`comments_id` ASC) VISIBLE,
  INDEX `fk_post_has_comments_post1_idx` (`post_id` ASC) VISIBLE,
